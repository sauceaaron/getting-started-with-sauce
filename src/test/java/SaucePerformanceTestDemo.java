...
public class SaucePerformanceTestDemo
{
	...
	public void setup(Method method) throws MalformedURLException
	{
		...
		// --- THESE TWO CAPABILITIES ARE ALL THAT IS REQUIRED
		// --- TO ENABLE PERFORMANCE METRICS IN A TEST
		sauceOptions.setCapability("extendedDebugging", true);
		sauceOptions.setCapability("capturePerformance", true);

		MutableCapabilities capabilities = new MutableCapabilities();

		// --- CHROME IS THE ONLY BROWSER SUPPORTED FOR PERFORMANCE
	...
	public void performanceTestDemo()
	{
		...
		double score = (Double) performance.get("score");
...
//		logType.put("type", "sauce:performance");
		Map<String, Object> performance = (Map<String, Object>)
//				driver.executeScript("sauce:log", logType);
				driver.executeScript("sauce:performance");
